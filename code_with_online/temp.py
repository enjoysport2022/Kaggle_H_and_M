...
def get_itemcf_recall(data, target_df, df,
    ...
    sim_item_corr, user_item_dict, user_time_dict, user_price_dict = get_sim_item(df, uid, iid, use_iif=use_iif,
                                                                                  time_max=time_max)
...
def itemcf_recall(uids, data, date, uid, iid, time_col, last_days=7, recall_num=100, dtype='train', topk=1000,
                  use_iif=False, sim_last_days=14):
